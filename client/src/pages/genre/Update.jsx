...
const Update = ({ match }) => {
    ...
    useEffect(() => {
        axios.get(`https://mern-mvc-chandar.onrender.com/api/books/${match.params._id}`).then(response => {
    ...
    const handleFormSubmission = () => {
        axios
            .put(`https://mern-mvc-chandar.onrender.com/api/genre/${match.params._id}`, genre)
